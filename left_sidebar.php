  ...
  <div class="row content">
    ...
    <div class="col-sm-3 sidenav">
      ...
      <ul class="nav nav-pills nav-stacked">
        <?php
        if($core->activeAuth == true){
          if($core->is_loggedIn()){   ;?>
          <li class="<?= ($core->currentPage == 'dashboard.php') ? 'active' : ''  ;?>"><a href="dashboard.php">Dashboard</a></li>
          <li class="<?= ($core->currentPage == 'user.php') ? 'active' : ''  ;?>"><a href="user.php">User Datatable VIA JS</a></li>
          <li class="<?= ($core->currentPage == 'user_datatable.php') ? 'active' : ''  ;?>"><a href="user_datatable.php">User Datatable Via PHP</a></li>
